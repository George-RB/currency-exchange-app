...
router.post(
  'https://currency-exchange-app-zkkc.onrender.com/rates',
  simpleAuth,
  async (req, res) => {
...
router.post(
  'https://currency-exchange-app-zkkc.onrender.com/reset-rates',
  simpleAuth,
  (req, res) => {
    const user = req.user;
...
router.get(
  'https://currency-exchange-app-zkkc.onrender.com/reports',
  simpleAuth,
  (req, res) => {
    connection.query(
